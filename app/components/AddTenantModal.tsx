  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5 md:space-y-6">
        {errors.submit && (
          <div className="rounded-lg bg-red-50 p-3 sm:p-4 text-sm text-red-600 border border-red-200">
            {errors.submit}
          </div>
        )}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
          <div>
            ...
            <input
              ...
              className={cn(
                "w-full px-3 sm:px-4 py-2 sm:py-2.5 text-sm sm:text-base rounded-lg border transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500",
                errors.name
        ...
        <div>
          ...
          />
          {errors.shopNumber && (
            <p className="mt-1 text-xs sm:text-sm text-red-600">{errors.shopNumber}</p>
          )}
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
          <div>
            ...
            />
            {errors.depositAmount && (
              <p className="mt-1 text-xs sm:text-sm text-red-600">{errors.depositAmount}</p>
            )}
          </div>
          ...
          <div>
            ...
            />
            {errors.monthlyRent && (
              <p className="mt-1 text-xs sm:text-sm text-red-600">{errors.monthlyRent}</p>
            )}
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
          <div>
            ...
            />
            {errors.leaseStartDate && (
              <p className="mt-1 text-xs sm:text-sm text-red-600">{errors.leaseStartDate}</p>
            )}
          </div>
          ...
          <div>
            ...
            />
            {errors.leaseEndDate && (
              <p className="mt-1 text-xs sm:text-sm text-red-600">{errors.leaseEndDate}</p>
            )}
          </div>
        </div>
        ...
        <div className="flex flex-col-reverse sm:flex-row justify-end gap-2 sm:gap-3 pt-4 sm:pt-5 md:pt-6 border-t border-gray-200">
          <button
            ...
            onClick={onClose}
            disabled={isLoading}
            className="w-full sm:w-auto px-4 sm:px-6 py-2.5 sm:py-2 rounded-lg border border-gray-300 bg-white font-medium text-sm sm:text-base text-gray-700 transition-colors hover:bg-gray-50 disabled:opacity-50"
          >
            Cancel
          </button>
          <button
            type="submit"
            disabled={isLoading}
            className="w-full sm:w-auto px-4 sm:px-6 py-2.5 sm:py-2 rounded-lg bg-blue-600 font-medium text-sm sm:text-base text-white transition-colors hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed"
          >
